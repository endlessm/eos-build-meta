...
# Wrapper for BuildStream to maintain a local OSTree repo.
#
# This script handles the following:
#
#   * Building the system artifact and exporting it
#   * Signing the tree and pulling it into a local repo
#
# Script taken from Freedesktop SDK 24.08.22.
...
${BST:-bst} artifact checkout --hardlinks "${element}" --directory "${checkout}"
